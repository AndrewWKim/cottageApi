...
namespace CottageApi.Data.Migrations
{
    ...
    [Migration("20200723104924_AddedBillNumberToCommunalBills")]
    partial class AddedBillNumberToCommunalBills
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CottageApi.Core.Domain.Entities.CommunalType", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("CottageApi.Core.Domain.Entities.CommunalBill", b =>
                {
                    b.HasOne("CottageApi.Core.Domain.Entities.CommunalType", "CommunalType")
                        .WithMany()
                        .HasForeignKey("CommunalTypeId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
